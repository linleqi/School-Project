...
def updateprofile():
    ...
    frame5 = tkinter.Frame(window1, bg = "PaleTurquoise2", borderwidth = "1", padx = "25", pady = "35", relief = tkinter.GROOVE)
    font1 = ("Verdana", 15, "bold")
    font2 = ("Comic Sans MS", 15, "bold")
    ...
    global lblx
    lblx = tkinter.Label(window1, bg = "blue", fg = "red")

    frame5.place(relx =0.5, rely=0.5,anchor=tkinter.CENTER)

    # FRAME 4
    global frame6
    frame6=tkinter.Frame(window1, bg = "PaleTurquoise2", borderwidth = "1", padx = "15", pady = "15", relief = tkinter.GROOVE)
    ...
    global lblx2
    lblx2 = tkinter.Label(window1, bg = "blue", fg = "red")
...
def profilewindow(record):
    ...
    global window1
    window1 = tkinter.Tk()
    window1.geometry("1300x500")
    window1.configure(bg = "blue")
    window1.title("Tutor Finder!")
    
    # 11 columns
    # Start:3 End:9
    headinglbl = tkinter.Label(window1, text = "Student4Student", font = "Verdana 40 bold")
    headinglbl.grid(row=0, column=2, columnspan=7)

    profilelbl = tkinter.Label(window1, text = "PROFILE", font = "Verdana 20 bold")
    profilelbl.grid(row=1, column=0, columnspan=2, rowspan=2)

    piclbl = tkinter.Label(window1, image = profilepic, font = "Verdana 20 bold")
    ...
    Emaillbl = tkinter.Label(dataFrame, text = "Email:", font = "Verdana 20 bold")
    Emaillbl.grid(row=1, column=0)

    EmailVallbl = tkinter.Label(dataFrame, text = record[0], font = "Verdana 20 bold")
    EmailVallbl.grid(row=1, column=1, columnspan=2)

    FirstNameLbl = tkinter.Label(dataFrame, text="First Name:", font = "Verdana 20 bold")
    FirstNameLbl.grid(row=2, column=0)

    FirstNameValLbl = tkinter.Label(dataFrame, text=record[2], font = "Verdana 20 bold")
    FirstNameValLbl.grid(row=2, column=1, columnspan=2)

    LastNameLbl = tkinter.Label(dataFrame, text="Last Name:", font = "Verdana 20 bold")
    LastNameLbl.grid(row=3, column=0)

    LastNameValLbl = tkinter.Label(dataFrame, text=record[3], font = "Verdana 20 bold")
    LastNameValLbl.grid(row=3, column=1, columnspan=2)

    DateLbl = tkinter.Label(dataFrame, text="Date:", font = "Verdana 20 bold")
    DateLbl.grid(row=4, column=0)

    DateValLbl = tkinter.Label(dataFrame, text=record[7], font = "Verdana 20 bold")
    DateValLbl.grid(row=4, column=1, columnspan=2)

    subPrefLbl = tkinter.Label(dataFrame, text = "Subject Preferences", font = "Verdana 20 bold")
    subPrefLbl.grid(row=0, column=4)

    testPrefLbl = tkinter.Label(dataFrame, text = "Test Preferences", font = "Verdana 20 bold")
    testPrefLbl.grid(row=0, column=5)

    sub1Lbl = tkinter.Label(dataFrame, text=record[8], font = "Verdana 20 bold")
    sub1Lbl.grid(row=1, column=4)

    sub2Lbl = tkinter.Label(dataFrame, text=record[9], font = "Verdana 20 bold")
    sub2Lbl.grid(row=2, column=4)

    sub3Lbl = tkinter.Label(dataFrame, text=record[10], font = "Verdana 20 bold")
    sub3Lbl.grid(row=3, column=4)

    sub4Lbl = tkinter.Label(dataFrame, text=record[11], font = "Verdana 20 bold")
    sub4Lbl.grid(row=4, column=4)

    sub5Lbl = tkinter.Label(dataFrame, text=record[12], font = "Verdana 20 bold")
    sub5Lbl.grid(row=5, column=4)

    test1Lbl = tkinter.Label(dataFrame, text=record[13], font = "Verdana 20 bold")
    test1Lbl.grid(row=1, column=5)

    test2Lbl = tkinter.Label(dataFrame, text=record[14], font = "Verdana 20 bold")
    test2Lbl.grid(row=2, column=5)

    test3Lbl = tkinter.Label(dataFrame, text=record[15], font = "Verdana 20 bold")
    test3Lbl.grid(row=3, column=5)

    test4Lbl = tkinter.Label(dataFrame, text=record[16], font = "Verdana 20 bold")
    test4Lbl.grid(row=4, column=5)

    test5Lbl = tkinter.Label(dataFrame, text=record[17], font = "Verdana 20 bold")
    test5Lbl.grid(row=5, column=5)

    tutorlookuplbl = tkinter.Label(window1, text="Tutor Look-up!", font = "Verdana 20 bold")
    tutorlookuplbl.grid(row=9, column=0, columnspan=1)

    subjects = tkinter.Button(window1, text = "By Subjects",bg = "RoyalBlue1", font = "Verdana 20 bold")
    subjects.grid(row=10, column=1, columnspan=2)

    test = tkinter.Button(window1, text = "By tests",bg = "RoyalBlue1", font = "Verdana 20 bold")
    test.grid(row=10, column=3, columnspan=2)

    college = tkinter.Button(window1, text = "By colleges",bg = "RoyalBlue1", font = "Verdana 20 bold")
    college.grid(row=10, column=5, columnspan=2)
    
    update = tkinter.Button(window1, text = "Update",bg = "RoyalBlue1", command = updateprofile, font = "Verdana 20 bold")
    update.grid(row=0, column=8)

import random
def profilepic():
    lst=["pig.png", "bear.png", "elephant.png","horse.png", "dog.png"]
