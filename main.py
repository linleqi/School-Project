...
def signupwindow():
    ...
    Emaillbl = tkinter.Label(frame3, text = "Email:", fg = "Blue4", font = font1)
    Emaillbl.grid(row=0,column=0)
    global Email
    Email = tkinter.Entry(frame3, font = font2)
    Email.grid(row=0,column=1)

    passwordlbl = tkinter.Label(frame3, text = "Password:", fg = "Blue4", font = font1)
    passwordlbl.grid(row=1,column=0)
    global Password
    Password = tkinter.Entry(frame3, show = "*", font = font2)
    Password.grid(row=1,column=1)

    firstnamelbl = tkinter.Label(frame3, text = "First Name:", fg = "Blue4", font = font1)
    firstnamelbl.grid(row=2,column=0)
    global FirstName
    FirstName = tkinter.Entry(frame3, font = font2)
    FirstName.grid(row=2,column=1)

    lastnamelbl = tkinter.Label(frame3, text = "Last Name:", fg = "Blue4", font = font1)
    lastnamelbl.grid(row=3,column=0)
    global LastName
    LastName = tkinter.Entry(frame3, font = font2)
    LastName.grid(row=3,column=1)

    back=tkinter.Button(frame3, text = "Go Back", bg = "RoyalBlue1", font = font1, command = lambda:[window.destroy(), main()])
    back.grid(row=4,column=0)
    
    next1=tkinter.Button(frame3, text = "Next", bg = "RoyalBlue1", font = font1, command = lambda:[frame3.place_forget(),frame4.place(relx =0.5, rely=0.5,anchor=tkinter.CENTER)])
    ...
    hslbl = tkinter.Label(frame4, text = "High School:", fg = "Blue4", font = font1)
    hslbl.grid(row=0,column=0)
    global Highschool
    Highschool = tkinter.Entry(frame4, font = font2)
    Highschool.grid(row=0,column=1)
    
    uglbl = tkinter.Label(frame4, text = "Undergraduate School:", fg = "Blue4", font = font1)
    ...
    glbl = tkinter.Label(frame4, text = "Graduate School:", fg = "Blue4", font = font1)
    glbl.grid(row=2,column=0)
    global Graduate
    Graduate = tkinter.Entry(frame4, font = font2)
    Graduate.grid(row=2,column=1)

    doblbl = tkinter.Label(frame4, text = "DOB:", fg = "Blue4", font = font1)
    doblbl.grid(row=3,column=0)
    
    yearlbl = tkinter.Label(frame4, text = "Year:", fg = "Blue4", font = "Verdana 15")
    ...
    monthlbl = tkinter.Label(frame4, text = "Month:", fg = "Blue4", font = "Verdana 15")
    ...
    daylbl = tkinter.Label(frame4, text = "Day:", fg = "Blue4", font = "Verdana 15")
    ...
    sub1lbl = tkinter.Label(frame4, text = "Subject 1:", fg = "Blue4", font = font1)
    ...
    sub2lbl = tkinter.Label(frame4, text = "Subject 2:", fg = "Blue4", font = font1)
    ...
    sub3lbl = tkinter.Label(frame4, text = "Subject 3:", fg = "Blue4", font = font1)
    ...
    sub4lbl = tkinter.Label(frame4, text = "Subject 4:", fg = "Blue4", font = font1)
    ...
    sub5lbl = tkinter.Label(frame4, text = "Subject 5:", fg = "Blue4", font = font1)
    ...
    test1lbl = tkinter.Label(frame4, text = "Test 1:", fg = "Blue4", font = font1)
    ...
    test2lbl = tkinter.Label(frame4, text = "Test 2:", fg = "Blue4", font = font1)
    ...
    test3lbl = tkinter.Label(frame4, text = "Test 3:", fg = "Blue4", font = font1)
    ...
    test4lbl = tkinter.Label(frame4, text = "Test 4:", fg = "Blue4", font = font1)
    ...
    test5lbl = tkinter.Label(frame4, text = "Test 5:", fg = "Blue4", font = font1)
    ...
    back=tkinter.Button(frame4, text = "Go Back",bg = "RoyalBlue1", font = font1, command = lambda:[frame4.place_forget(), frame3.place(relx =0.5, rely=0.5,anchor=tkinter.CENTER)])
...
def signup():
    ...
    DOB1 = Year.get()+"-"+monthDict[Month.get()]+"-"+Day.get()
