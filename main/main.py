...
con = sql.connect(
    host="localhost", user="root", passwd="grade12", database="PythonProject"
)
if con.is_connected():
...
def update(
    ...
    cursor.execute(
        "UPDATE AccDetails SET Password='{}', FirstName= '{}', LastName='{}', Highschool = '{}' ,Undergraduate='{}',Graduate='{}',DOB='{}',Sub1='{}',Sub2='{}',Sub3='{}',Sub4='{}',Sub5='{}',Test1='{}',Test2='{}',Test3='{}',Test4='{}',Test5='{}' WHERE Email = '{}'".format(
            Password,
            FirstName,
            LastName,
            Highschool,
...
def updateprofile():
    ...
    Emaillbl = tkinter.Label(
        frame5, text="Email:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    passwordlbl = tkinter.Label(
        frame5, text="Password:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    firstnamelbl = tkinter.Label(
        frame5, text="First Name:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    lastnamelbl = tkinter.Label(
        frame5, text="Last Name:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    cancel1 = tkinter.Button(
        frame5, text="Cancel", bg="RoyalBlue1", font=font1, command=cancelBtnFunc
    )
    cancel1.grid(row=4, column=0)

    next1 = tkinter.Button(
        frame5, text="Next", bg="RoyalBlue1", font=font1, command=nextBtnFunc1
    )
    ...
    hslbl = tkinter.Label(
        frame6, text="High School:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    glbl = tkinter.Label(
        frame6, text="Graduate School:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    doblbl = tkinter.Label(
        frame6, text="DOB:-", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    doblbl.grid(row=3, column=0)

    yearlbl = tkinter.Label(
        frame6, text="Year:", bg="PaleTurquoise1", fg="Blue4", font="Verdana 15"
    )
    ...
    monthlbl = tkinter.Label(
        frame6, text="Month:", bg="PaleTurquoise1", fg="Blue4", font="Verdana 15"
    )
    ...
    daylbl = tkinter.Label(
        frame6, text="Day:", bg="PaleTurquoise1", fg="Blue4", font="Verdana 15"
    )
    ...
    resetDOBBtn = tkinter.Button(
        frame6, text="Reset DOB", bg="RoyalBlue1", font=font1, command=resetDOB
    )
    resetDOBBtn.grid(row=7, column=1)

    subjectSelectlbl = tkinter.Label(
        frame6, text="Select subjects and tests you want to TEACH:", font=font1
    )
    subjectSelectlbl.grid(row=0, column=2, columnspan=4)

    sub1lbl = tkinter.Label(
        frame6, text="Subject 1:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    sub2lbl = tkinter.Label(
        frame6, text="Subject 2:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    sub3lbl = tkinter.Label(
        frame6, text="Subject 3:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    sub4lbl = tkinter.Label(
        frame6, text="Subject 4:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    sub5lbl = tkinter.Label(
        frame6, text="Subject 5:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    test1lbl = tkinter.Label(
        frame6, text="Test 1:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    test2lbl = tkinter.Label(
        frame6, text="Test 2:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    test3lbl = tkinter.Label(
        frame6, text="Test 3:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    test4lbl = tkinter.Label(
        frame6, text="Test 4:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    test5lbl = tkinter.Label(
        frame6, text="Test 5:", bg="PaleTurquoise1", fg="Blue4", font=font1
    )
    ...
    resetSubsBtn = tkinter.Button(
        frame6,
        text="Reset Subjects",
        bg="RoyalBlue1",
        font=font1,
        command=resetSubjects,
    )
    resetSubsBtn.grid(row=6, column=3)

    resetTestsBtn = tkinter.Button(
        frame6, text="Reset Tests", bg="RoyalBlue1", font=font1, command=resetTests
    )
    resetTestsBtn.grid(row=6, column=5)

    cancel2 = tkinter.Button(
        frame6, text="Cancel", bg="RoyalBlue1", font=font1, command=cancelBtnFunc
    )
    cancel2.grid(row=9, column=3)

    submit = tkinter.Button(
        frame6, text="Sign up", bg="RoyalBlue1", font=font1, command=checksignup
    )
...
class searchWindow:
    def __init__(self, window):
        ...
        self.sublbl = tkinter.Label(self.frame1, text="By subjects:", font=font1)
        ...
        self.schoollbl = tkinter.Label(self.frame1, text="By schools:", font=font1)
    ...
    def search(self, subs):
        ...
        for record in records:
            ...
            if check is True:
                cursor.execute(
                    "SELECT * FROM AccDetails WHERE Email = '{}'".format(record[0])
                )
